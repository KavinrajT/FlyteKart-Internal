...
public class CreatePushNotificationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void openMaps() {
        Intent intent = new Intent(CreatePushNotificationActivity.this, MapsActivity.class);
